"""
Lavalink on Heroku Deployment Script.
"""
...
class LavalinkBootstrap:
    ...
    def __init__(self):
        ...
        self.run_command = f"java -jar target/Lavalink.jar {self._additional_options}" # User-provided config, will override heroku's
